...
library(coda)     # For MCMC diagnostics (effectiveSize, mcmc, etc.)
...
mu0      <- 7     # Prior mean for mu
sigma2_mu0 <- 5   # Prior variance for mu
nu0      <- 2     # Degrees of freedom for sigma2 prior
sigma20  <- 15    # Scale parameter for sigma2 prior
eta0     <- 2     # Degrees of freedom for tau2 prior
tau20    <- 10    # Scale parameter for tau2 prior
...
R_samples     <- numeric(n_iter)  # R = 1 + sigma2/tau2
...
# Compute prior for R via simulation
