...
```
I selected 3 factors becuase togeter they reach 70% cumulitive variance which is a common threshold

Factor 1 covers 29.6% of variance and seems to contrast t5 against t 1,3,4,6 as it has positive wieghts for those and a negative weight for t5.. Factor 2 accounts for 22.6% of variance is largely accounting for T2 and has opposite sighns for t 4 and 5.. PC3 accounts for another 17% of variance, and contrasts t3 agaisnt t1,5 and 6. Altogether thses are hard to interpret.
...
The three components accoutn for a lot of the variance. we see that 4 of 6 commonalities are above .7 meaning that 70% of their variance is accounted for. T2 is the most explained, and T3 is the least explained with .529 commonality.
