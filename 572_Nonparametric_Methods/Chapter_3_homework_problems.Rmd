...
ranked_group_1 <- ranks[1:5]
ranked_group_2 <- ranks[6:10]
ranked_group_3 <- ranks[11:15]

KW_obs = 
  (12/(N*(N+1))) * sum(
        (mean(ranked_group_1) - (N+1)/2)^2,
        (mean(ranked_group_2) - (N+1)/2)^2,
        (mean(ranked_group_3) - (N+1)/2)^2
)
...
for (k in 1:10000) {
  ...
  KW = 
  (12/(N*(N+1))) * sum(
        (mean(group_1_perm) - (N+1)/2)^2,
        (mean(group_2_perm) - (N+1)/2)^2,
        (mean(group_3_perm) - (N+1)/2)^2
  )
  KW_stats[k] = KW
